                    ...
                    <div class="field">
                        <div class="ui vertical ui center aligned segment form">
                            ...
                            <%
                                ...
                                if (localAuthenticatorNames.contains("OpenID4VPAuthenticator")) {
                            %>
                            <div class="social-login blurring social-dimmer">
                                <div class="field">
                                    <button
                                        ...
                                        id="icon-<%=iconId%>"
                                        class="ui button secondary"
                                        data-testid="login-page-sign-in-with-wallet"
                                        onclick="handleNoDomain(this,
                                                '<%=Encode.forJavaScriptAttribute(Encode.forUriComponent(idpEntry.getKey()))%>',
                                    ...
                                    >
                                        <img
                                            class="ui image"
                                            src="libs/themes/default/assets/images/authenticators/wallet.svg"
                                            alt="Wallet Logo"
                                            role="presentation">
                                        <span>
                                            <%=AuthenticationEndpointUtil.i18n(resourceBundle, "sign.in.with")%>
