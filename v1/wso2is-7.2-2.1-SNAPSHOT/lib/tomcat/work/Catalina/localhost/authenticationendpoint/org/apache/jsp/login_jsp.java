 ...
 * Generated at: 2026-01-21 04:06:49 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/includes/init-url.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/includes/localize.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/includes/username-label-resolver.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/identifierauth.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/tenantauth.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/includes/layout-resolver.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/basicauth.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/includes/init-loginform-action-url.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/util/dynamic-portal-url-resolver.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/includes/branding-preferences.jsp", Long.valueOf(1767792836000L));
    _jspx_dependants.put("/WEB-INF/lib/org.wso2.identity.apps.taglibs.layout.controller-3.3.34-SNAPSHOT.jar", Long.valueOf(1768967634000L));
    _jspx_dependants.put("jar:file:/Users/udeepa/Desktop/VC/IS-Packs/v1/wso2is-7.2-2.1-SNAPSHOT/repository/deployment/server/webapps/authenticationendpoint/WEB-INF/lib/org.wso2.identity.apps.taglibs.layout.controller-3.3.34-SNAPSHOT.jar!/META-INF/taglib.tld", Long.valueOf(1768967626000L));
    _jspx_dependants.put("/plugins/basicauth-extensions.jsp", Long.valueOf(1767792836000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(114);
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      // /login.jsp(481,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
      // /login.jsp(481,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
      // /login.jsp(481,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /login.jsp(482,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          // /login.jsp(501,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (!StringUtils.equals("CONSOLE",clientId)
 ...
 if (isSelfSignUpEPAvailable && !isIdentifierFirstLogin(inputType)) { 
              ...
              out.print(StringEscapeUtils.escapeHtml4(getRegistrationPortalUrl(accountRegistrationEndpointURL, urlEncodedURL, urlParameters)));
              out.write("';\"\n");
...
if (idpAuthenticatorMapping != null &&
 ...
 if (GOOGLE_ONE_TAP_ENABLED) { 
              ...
              out.write("\"\n");
              out.write("                                        class=\"ui button secondary\"\n");
              out.write("                                        data-testid=\"login-page-sign-in-with-wallet\"\n");
              out.write("                                        onclick=\"handleNoDomain(this,\n");
              out.write("                                                '");
              out.print(Encode.forJavaScriptAttribute(Encode.forUriComponent(idpEntry.getKey())));
              out.write("',\n");
              out.write("                                                'OpenID4VPAuthenticator')\"\n");
              out.write("                                    >\n");
              out.write("                                        <img\n");
              out.write("                                            class=\"ui image\"\n");
              out.write("                                            src=\"libs/themes/default/assets/images/authenticators/wallet.svg\"\n");
              out.write("                                            alt=\"Wallet Logo\"\n");
              out.write("                                            role=\"presentation\">\n");
              out.write("                                        <span>\n");
              out.write("                                            ");
              out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "sign.in.with"));
 ...
 if(StringUtils.isNotBlank(selfSignUpOverrideURL)) { 
          ...
          // /login.jsp(1329,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (Boolean.parseBoolean(request.getParameter("isSelfRegistration"))) { 
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /login.jsp(1340,8) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
